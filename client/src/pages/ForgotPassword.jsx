      ...
      <aside className="relative hidden lg:flex lg:w-5/12 flex-col justify-between bg-brand-950 text-slate-100 p-12 overflow-hidden">
        ...
        <div className="relative max-w-md">
          ...
          <p className="mt-4 text-slate-300 leading-relaxed">
            Submit your work email and IT will issue a temporary password through a secure channel.
            Resets are handled by an administrator — there is no self-serve reset link.
          </p>

          <ul className="mt-8 space-y-3 text-sm text-slate-200">
            <Bullet>Requests are logged and reviewed by IT</Bullet>
            <Bullet>You'll receive a temporary password to sign in</Bullet>
            <Bullet>Change it from Settings once you're back in</Bullet>
          </ul>
        </div>
        ...
        <div className="min-h-full flex items-center justify-center px-6 py-10 sm:px-10">
          <div className="w-full max-w-md">
                ...
                <div>
                  ...
                  <div className="mt-5 flex items-start gap-3 rounded-md bg-accent-50 ring-1 ring-accent-200 px-3 py-3">
                    ...
                    <p className="text-sm text-accent-800 leading-relaxed">
                      If an account exists for <span className="font-mono">{email.trim()}</span>, an IT
                      administrator has been notified and will reach out with a temporary password.
                    </p>
                  </div>
                ...
                <>
                  <div>
                    ...
                    <p className="mt-1.5 text-sm text-slate-600">
                      Enter your work email and IT will issue a temporary password.
                    </p>
                  </div>
            ...
            <p className="mt-6 text-[11px] text-slate-500 leading-relaxed text-center">
              Resets are issued by IT staff only. Sharing a password — even temporarily — is against
              Eljin Corp policy. Change it from <span className="font-semibold">Settings</span> the moment you're back in.
            </p>
          </div>
        </div>
      </main>
