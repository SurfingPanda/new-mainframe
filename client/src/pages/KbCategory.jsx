    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="container-app py-10 space-y-6">
        ...
        <section className="grid gap-3 sm:grid-cols-3">
          <StatCard label={`${category} articles`} value={counts.total} tone="brand" />
          ...
          {loading ? (
            ...
            <div className="px-5 py-16 text-center">
              ...
              {canEdit && articles.length === 0 && (
                <button onClick={handleNew} className="mt-4 inline-flex text-xs font-semibold text-accent-700 hover:text-accent-800">
